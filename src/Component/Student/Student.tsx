...
import SysCollege from "./SysCollege/SysCollege";
...
class Student extends React.Component<Props> {
    render() {
        ...
        const collegeFeatureArr = [0,1, 2, 3];
        const collegeFeatures = collegeFeatureArr.map(x =>
            <div className="Student-3-CollegeFeature-margin">
                <CollegeFeature myKey={x.toString()}/>
            </div>
        );
        const sysCollege = <SysCollege/>
        ...
        return (
            <div style={{width: "100%"}}>
                ...
                >
                    ...
                    <p className="Student-1-subtitle">108課綱資訊教育上路 </p>
                    <p className="Student-1-subtitle">我們讓孩子如飛鷹展翅上騰</p>
                </div>
                ...
                <div className="Student-pos-rel Student-7 Student-block">
                    <div>
                        <div className="Student-2-title">六位世界級顧問領軍</div>
                        <div className="Student-2-subtitle">專業級的教室團隊</div>
                    </div>
                ...
                <div className="Standard-outline">
                    <div className="Standard-outline-title">
                       參考全家145國家使用CSTA標準<br/>
                        美國NGSS{'<'}新一代K12教學標準{'>'}
                    </div>
                    <div className="Standard-outline-subtitle">
                        搭配108年課綱需求精心設計課程
                    </div>
                </div>
                ...
                <div className="Twelve-application-theme">
                    <div>
                        <div className="Student-2-title">12個應用主題</div>
                        <div className="Student-2-subtitle">可以放介紹文字></div>
                    </div>
                    <div>
                       <div className="Twelve-application-card1">
                           <StarGen number={4} name={"共享單車 | 難度"}/>
                           學習數據分析與可視化套件，<br/>
                           支援維度陣列與矩陣運算，<br/>
                           透過標籤和索引來整理資料格式。
                       </div>
